...
for utterance in utterances:
	...
	utterance = [re.sub(u'Ai', u'<i', word) for word in utterance]
	utterance = [re.sub(u'Aa', u'>a', word) for word in utterance]
	utterance = [re.sub(u'Au', u'>u', word) for word in utterance]
	utterance = [re.sub(u'^>([^auAw])', u'>a\\1', word) for word in utterance]
	utterance = [re.sub(u' >([^auAw ])', u' >a\\1', word) for word in utterance]
	utterance = [re.sub(u'<([^i])', u'<i\\1', word) for word in utterance]
